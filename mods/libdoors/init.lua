...
minetest.register_node("libdoors:hidden", {
...
minetest.register_alias("doors:hidden", "libdoors:hidden")
...
function doors.register(name, def)
	...
	minetest.register_lbm({
		...
		action = function(pos, node)
			...
			-- properly place libdoors:hidden at the right spot
			local p3 = p2
			if new.state >= 2 then
				p3 = (p3 + 3) % 4
			end
			...
			minetest.set_node({x = pos.x, y = pos.y + 1, z = pos.z},
				{name = "libdoors:hidden", param2 = p3})
		end
	})
	...
	minetest.register_craftitem(":" .. name, {
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			if minetest.get_item_group(minetest.get_node(aside).name, "door") == 1 then
				...
				minetest.set_node(above, {name = "libdoors:hidden", param2 = (dir + 3) % 4})
			else
				minetest.set_node(pos, {name = name .. "_a", param2 = dir})
				minetest.set_node(above, {name = "libdoors:hidden", param2 = dir})
			end
